# -*- coding: utf-8 -*-
#
# aiida-phonopy documentation build configuration file, created by
...
copyright = u'2022, Lorenzo Bastonero, Atsushi Togo, Abel Carreras'
author = u'Lorenzo Bastonero, Atsushi Togo, Abel Carreras'
