...
copyright = f"""2022-{time.localtime().tm_year}, University of Bremen, Germany. All rights reserved"""

# The full version, including alpha/beta/rc tags.
release = aiida_phonopy.__version__
# The short X.Y version.
version = '.'.join(aiida_phonopy.__version__.split('.')[:2])
...
intersphinx_mapping = {
    ...
    'np': ('https://numpy.readthedocs.io/en/latest/', None),
...
# autoapi_ignore = [filepath_src / 'aiida_phonopy' / '*cli*']
...
html_theme_options = {
    'github_url': 'https://github.com/aiida-phonopy/aiida-phonopy',
    'use_edit_page_button': True,
}
html_static_path = ['_static']
html_context = {
    'github_user': 'aiida-phonopy',
    'github_repo': 'aiida-phonopy',
    'github_version': 'main',
...
html_use_opensearch = 'http://aiida-phonopy.readthedocs.io'
...
htmlhelp_basename = 'aiida-phonopydoc'
